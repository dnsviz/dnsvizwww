...
urlpatterns = patterns('',
        ...
        url(r'^d/(?P<name>%s)/(?P<timestamp>%s)/$' % (dns_name, timestamp), never_cache(views.DomainNameDetailView.as_view())),
        url(r'^d/(?P<name>%s)/(?P<timestamp>%s)/(?P<url_subdir>dnssec/)$' % (dns_name, timestamp), never_cache(views.DomainNameDNSSECPageView.as_view())),
        url(r'^d/(?P<name>%s)/(?P<timestamp>%s)/(?P<url_subdir>servers/)$' % (dns_name, timestamp), never_cache(views.DomainNameServersView.as_view())),
        url(r'^d/(?P<name>%s)/(?P<timestamp>%s)/(?P<url_subdir>responses/)$' % (dns_name, timestamp), never_cache(views.DomainNameResponsesView.as_view())),
        url(r'^d/(?P<name>%s)/(?P<timestamp>%s)/(?P<url_subdir>dnssec/)(?P<url_file>auth_graph)\.(?P<format>png|jpg|svg|dot|js)$' % (dns_name, timestamp), never_cache(views.DomainNameDNSSECGraphView.as_view())),
        url(r'^d/(?P<name>%s)/(?P<timestamp>%s)/(?P<url_subdir>REST/)(?P<rest_dir>(raw|processed)/)$' % (dns_name, timestamp), never_cache(views.DomainNameRESTView.as_view())),

        url(r'^d/(?P<name>%s)/(r|e)/(?P<group_id>\d+)/$' % dns_name, never_cache(views.DomainNameDetailGroupView.as_view())),
        url(r'^d/(?P<name>%s)/(r|e)/(?P<group_id>\d+)/(?P<url_subdir>dnssec/)$' % dns_name, never_cache(views.DomainNameDNSSECPageGroupView.as_view())),
        url(r'^d/(?P<name>%s)/(r|e)/(?P<group_id>\d+)/(?P<url_subdir>servers/)$' % dns_name, never_cache(views.DomainNameServersGroupView.as_view())),
        url(r'^d/(?P<name>%s)/(r|e)/(?P<group_id>\d+)/(?P<url_subdir>responses/)$' % dns_name, never_cache(views.DomainNameResponsesGroupView.as_view())),
        url(r'^d/(?P<name>%s)/(r|e)/(?P<group_id>\d+)/(?P<url_subdir>dnssec/)(?P<url_file>auth_graph)\.(?P<format>png|jpg|svg|dot|js)$' % dns_name, never_cache(views.DomainNameDNSSECGraphGroupView.as_view())),
        url(r'^d/(?P<name>%s)/(r|e)/(?P<group_id>\d+)/(?P<url_subdir>REST/)(?P<rest_dir>(raw|processed)/)$' % dns_name, never_cache(views.DomainNameRESTGroupView.as_view())),
