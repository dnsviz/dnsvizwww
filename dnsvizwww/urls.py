...
urlpatterns = patterns('',
        ...
        url(r'^d/(?P<name>%s)/(?P<timestamp>%s)/(?P<url_subdir>REST/)(?P<rest_dir>(raw|analysis)/)$' % (dns_name, timestamp), never_cache(views.DomainNameRESTView.as_view())),

        url(r'^d/(?P<name>%s)/e/(?P<explicit_delegation_group_id>\d+)/$' % dns_name, never_cache(views.DomainNameDetailExplicitDelegationView.as_view())),
        url(r'^d/(?P<name>%s)/e/(?P<explicit_delegation_group_id>\d+)/(?P<url_subdir>dnssec/)$' % dns_name, never_cache(views.DomainNameDNSSECPageExplicitDelegationView.as_view())),
        url(r'^d/(?P<name>%s)/e/(?P<explicit_delegation_group_id>\d+)/(?P<url_subdir>servers/)$' % dns_name, never_cache(views.DomainNameServersExplicitDelegationView.as_view())),
        url(r'^d/(?P<name>%s)/e/(?P<explicit_delegation_group_id>\d+)/(?P<url_subdir>responses/)$' % dns_name, never_cache(views.DomainNameResponsesExplicitDelegationView.as_view())),
        ...
        url(r'^d/(?P<name>%s)/e/(?P<explicit_delegation_group_id>\d+)/(?P<url_subdir>REST/)(?P<rest_dir>(raw|analysis)/)$' % dns_name, never_cache(views.DomainNameRESTExplicitDelegationView.as_view())),
